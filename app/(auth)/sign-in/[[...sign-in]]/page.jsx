...
export default function Page() {
  ...
  // Keep the user on this page even if they are already signed in
  useEffect(() => {
    if (isLoaded && isSignedIn) {
      // do **nothing** – stay on sign-in
    }
  }, [isLoaded, isSignedIn]);
    ...
    <section className="bg-white">
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
        ...
        <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
          <img
            alt="Background"
            src="/aa.jpg"               // put aa.jpg in /public
        ...
        <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
          <div className="max-w-xl lg:max-w-3xl">
            ...
            <div className="relative -mt-16 block lg:hidden">
              <a
                className="inline-flex size-16 items-center justify-center rounded-full bg-white text-blue-600"
                href="/"
              >
                <span className="sr-only">Home</span>
                <svg
            ...
            {/* CLERK SIGN-IN – MANUAL ONLY */}
            <SignIn
              routing="path"
              signUpUrl="/sign-up"
              afterSignInUrl="/dashboard"   // only after **manual click**
              // Prevent Clerk from auto-redirecting
